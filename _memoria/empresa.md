...
**Nome:** BK Solutions
**Negócio:** Implementação de IA em empresas B2B, combinada com marketing digital de performance
**O que faz:** Implementa IA dentro de processos reais de empresas B2B e conecta isso a uma máquina de marketing (site, tráfego pago, automação de atendimento, dados)
